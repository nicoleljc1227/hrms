...
import com.nicole.hrms.service.DepartmentService;
import com.nicole.hrms.util.ResponseUtil;
...
public class DepartmentController {
    ...
    public String list(HttpServletResponse response, Department department) throws Exception{
        ...
        List<Department> departmentList = departmentService.findDepartments(map);
     ...
     * @throws Exception
     */
    @RequestMapping("/delete")//可以不用指定method
